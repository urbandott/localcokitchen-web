    ...
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/85 backdrop-blur">
      <div className="container-page flex h-16 items-center justify-between gap-4">
        ...
        <nav className="hidden items-center gap-7 text-sm font-medium text-muted-foreground md:flex">
          ...
          <Link href="/#cook-cta" className="transition-colors hover:text-foreground">
            Become a cook
          </Link>
        </nav>
        <div className="flex items-center gap-2">
          <Link
            href="/signin/"
            className="hidden h-10 items-center rounded-full px-4 text-sm font-medium text-foreground hover:bg-secondary sm:inline-flex"
          >
            Sign in
          </Link>
          <Link
            href="/signup/"
            className="inline-flex h-10 items-center rounded-full bg-foreground px-4 text-sm font-semibold text-background hover:bg-foreground/90"
          >
            Get started
          </Link>
          <button
